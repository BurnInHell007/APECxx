...
//////////////////////////////////////////////////////////////////////
/// @brief Function for lossless convertion of int16_t to other format
/// @tparam T
/// @param sample int16_t 
/// @return <T> sample
template <typename T>
T convert_sample (int16_t sample) { // no effect on upcasting
    return sample;
}
...
// Float range [-1.0 to 1.0] so explicit conversion is needed
//////////////////////////////////////////////////////////////////////
/// @brief Function for lossless convertion of float to other format
/// @tparam T 
/// @param sample float
/// @return <T> sample
template <typename T>
